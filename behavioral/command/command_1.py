...
if __name__ == '__main__':
    bedrrom_light = Light('Luz 1', 'Quarto')
    bathroom_light = Light('Luz 2', 'Banheiro')

    bedrrom_light_on = LightOnCommand(bedrrom_light)
    bathroom_light_on = LightOnCommand(bathroom_light)
    bedroom_light_blue = LightChangeColor(bedrrom_light, 'Blue')
    bedroom_light_red = LightChangeColor(bedrrom_light, 'Red')

    remote = RemoteController()

    remote.button_add_command('first_button', bedrrom_light_on)
