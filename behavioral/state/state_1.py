...
class PaymentRejected(OrderState):
    def pending(self) -> None:
        print('Pagamento recusado! Não é possível colocar como pendente!')

    def approve(self) -> None:
        print('Pagamento recusado! Não é possível aprovar o pagamento!')

    def reject(self) -> None:
        print('Pagamento já recusado! Não recusarei novamente!')
